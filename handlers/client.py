...
async def delivery(message: types.Message):
    await bot.send_message(message.from_user.id,
                           "Вы можете выбрать следующие способы доставки: \n ✔️ Самовывоз ул. Садовая-Сухаревская 15с1 (Есть бесплатная парковка) \n ✔️ Курьером по Москве внутри МКАД 2-3 дня — 350₽, за МКАД до 10 км 2-3 дня — 450₽ Пн-Вс с 11.30 до 21.00 \n ✔️ Отправка такси до подъезда по Москве в день заказа - рассчитывается индивидуально \n ✔️ Доставка за МКАД свыше 10км и по России транспортной компанией СДЭК - 450₽ от 2 до 16 дней \n ✔️ Доставка по РФ Почтой России - рассчитывается индивидуально", reply_markup=kb_client)
